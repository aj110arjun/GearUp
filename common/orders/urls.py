...
urlpatterns = [
    ...
    path('<int:order_id>/request-return/', views.request_return, name='request_return'),
    ...
    path('admin/<int:order_id>/invoice/', views.admin_download_invoice, name='admin_download_invoice'),
    ...
    path('returns/<int:order_id>/view/', views.admin_view_return, name='admin_view_return'),
    path('<int:order_id>/return/approve/', views.admin_approve_return, name='admin_approve_return'),
    path('<int:order_id>/return/reject/', views.admin_reject_return, name='admin_reject_return'),
    path('<int:order_id>/return/complete/', views.admin_complete_return, name='admin_complete_return'),
    ...
    path('order/<int:order_id>/approve-return/', views.admin_approve_return, name='admin_approve_return'),
    path('order/<int:order_id>/reject-return/', views.admin_reject_return, name='admin_reject_return'),
    path('order/<int:order_id>/complete-return/', views.admin_complete_return, name='admin_complete_return'),    
]