...
urlpatterns = [
    ...
    path('cart/update/', views.update_cart_item_ajax, name='update_cart_item_ajax'),
    path('cart/update-variant/', views.update_cart_variant_ajax, name='update_cart_variant_ajax'),
