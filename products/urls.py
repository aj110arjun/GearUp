...
urlpatterns = [
    ...
    path('admin/products/view/<uuid:product_id>/', views.admin_product_view, name='admin_product_view'),
    ...
    path('admin/product/toggle-status/<uuid:product_id>/', views.toggle_product_status, name='toggle_product_status'),
